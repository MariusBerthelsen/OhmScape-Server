...
public class messageSpammerTimer {
	...
	public static void massMessageHandler() {
		...
		String[] messages = { 
				// h'ween "@or1@Happy Halloween from OhmScape! Pumpkins & Scythes drop this weekend!",
				// xmas "@red@Merry @gre@Christmas <col=FF0077>from OhmScape! Help Santa via the Snomwan at home.",
				...
				"Check our forums to stay up to date on everything OhmScape!",
				...
				//"Thank you for playing OhmScape!",
				...
				"Have questions? Ask in the clanchat \"OhmScape!\"",
